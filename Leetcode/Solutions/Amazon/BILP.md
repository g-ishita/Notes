...
I worked as an NLP Engineering Intern at ShareKhan by BNP Paribas, a financial technology startup, where I spearheaded the development of an AI-powered financial chatbot. Here, I also worked on decoder-style models that enhanced how users interact with financial data. Following this, I built a healthcare policy management platform at Optum that could successfully serve thousands of healthcare policies from multiple clients and showcased my ability to deliver scalable, real-world solutions. At Johns Hopkins Medicine, I’m currently working on benchmarking state-of-the-art multimodal LLMs on medical data and fine-tuning them using instruct-tuning and reinforcement learning from human feedback. My experience with high performace DL librabries such as DeepSpeed, and HF Accelerate have equipped me to run and train such models on distributed high-performance clusters. 
 
Throughout this time, I have actively contributed to AI research as well. I have published papers on temporal topic modeling at the EAI PervasiveHealth 2024 conference in Greece and presented a live demo of my work at the PyData event in NYC last year. Apart from that, my role as a graduate teaching assistant has allowed me to share my passion for machine learning and foster a productive learning environment.
...
As a loyal consumer myself, I've experienced firsthand the customer-centric mindset that defines Amazon's brand. As a passionate CS engineer, the sheer scope and scalability of Amazon's pioneering technical services is inspiring. For instance, major organizations like Intuit and Slack rely on Amazon’s robust infrastructure to power their AI-driven features, while Heroku, a platform I have personally used for my own projects, is built on AWS. Anthropic, another such platform, leverages AWS as its primary cloud provider. It would be an incredible opportunity to contribute to the systems that form the backbone of so many innovative applications, and continuously grow as an engineer at Amazon. 
